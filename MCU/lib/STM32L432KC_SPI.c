...
void initSPI(int br, int cpol, int cpha) { //1 0 0
    ...
    GPIOB->AFR[0] |= _VAL2FLD(GPIO_AFRL_AFSEL3, 5); // PB3
    GPIOB->AFR[0] |= _VAL2FLD(GPIO_AFRL_AFSEL5, 5); // PB5
    GPIOB->AFR[0] |= _VAL2FLD(GPIO_AFRL_AFSEL6, 5); // PA6
